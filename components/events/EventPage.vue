<template>
  <div class="event-page">
    ...
    >
      <div
        class="hero-Dekoverlay absolute inset-0 bg-gradient-to-r from-cyan-500/70 to-transparent"
      />
    ...
    <section v-if="location" class="map-section my-16 mx-auto max-w-6xl px-6">
      <ClientOnly>
        ...
        <template #fallback>
          <div
            class="h-[400px] bg-gray-200 rounded-lg flex items-center justify-center"
          >
...
withDefaults(defineProps<EventPageProps>(), { mapZoom: 15 });
